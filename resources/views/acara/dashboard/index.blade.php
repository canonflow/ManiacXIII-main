...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-10 w-full max-w-7xl">
        ...
        <div class="card rounded-lg shadow-md data">
            ...
            <div class="card-body bg-accent rounded-b-lg">
                ...
                {{--      Pagination      --}}
                <div class="mt-6">
                    {{ $rallyGames->onEachSide(1)->withQueryString()->links() }}
                </div>
            </div>
        </div>
    </div>
    ...
    <dialog id="modalTambah" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
            ...
            <form class="flex flex-col items-center justify-center mt-5 gap-y-6" method="POST" action="">
                @csrf
                ...
                <label for="" class="form-control w-full">
                    ...
                    <select class="select select-accent w-full" name="penpos_id">
