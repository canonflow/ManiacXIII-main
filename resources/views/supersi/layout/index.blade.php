...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-50 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-slate-700">
        ...
        <ul class="space-y-2 font-medium">
            {{-- Dashboard --}}
            <li class="">
                <a href="{{ route('super-si.index') }}" class="flex items-center p-2 rounded-lg {{ $pageActive == "super-si.dashboard" ? 'bg-slate-300 text-slate-800 ' : 'hover:bg-slate-100 group text-white hover:text-base-content' }} active:scale-95 transition-all">
            ...
            <li>
                <a href="{{ route('super-si.index') }}" class="flex items-center p-2 rounded-lg {{ $pageActive == "admin.registration" ? 'bg-slate-300 text-slate-800 ' : 'hover:bg-slate-100 group text-white hover:text-base-content' }} active:scale-95 transition-all">
            ...
            <li>
                <a href="{{ route('admin.users.index') }}" class="flex items-center p-2 rounded-lg {{ $pageActive == "admin.users" ? 'bg-slate-300 text-slate-800 ' : 'hover:bg-slate-100 group text-white hover:text-base-content' }} active:scale-95 transition-all">
