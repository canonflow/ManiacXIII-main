@extends('supersi.layout.index', ['pageActive' => 'super-si.player', 'pageTitle' => 'Player Market Log'])
    ...
    <div class="flex flex-col justify-center content-center w-full bg-slate-400 p-3 rounded-md mt-4">
        ...
        <div class="overflow-auto rounded" style="max-height: 450px">
            <table class="table table-xs table-pin-cols table-pin-rows">
                ...
                @else
                    <tr>
                        <td width="100%" class="font-medium text-lg text-slate-900 text-center" colspan="2">There are no market logs!</td>
                    </tr>
                @endif
                </tbody>
            </table>
