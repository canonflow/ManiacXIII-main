    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="flex flex-col justify-center items-center">
                <ul class="timeline timeline-vertical">
                    ...
                    <li class="h-32">
                        ...
                        <div class="timeline-end timeline-box rounded-lg">Penyisihan + TM Semi Final</div>
                        <hr/>
                    </li>
                    <li class="h-32">
                        <hr/>
                        ...
                        <div class="timeline-end timeline-box rounded-lg">Semi Final + TM Final</div>
                        <hr />
                    </li>
                    <li class="h-32">
                        <hr/>
        ...
        <div class="bg-base-200 flex flex-col p-4 rounded-md w-full lg:col-span-2 shadow-md gap-8 data relative">
            ...
            <div class="flex flex-col gap-3">
                <div class="badge badge-accent rounded-md font-medium text-sm">6 May 2024</div>
