...
<body>
    <div class="container-fluid bg-primary m-0 p-0">
        <div class="container d-flex justify-content-center align-items-center flex-column position-relative">
            <img src="{{ asset('asset2024/main/maniac.png') }}" alt="logo-maniac" class="w-75">
