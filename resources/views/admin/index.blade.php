...
<body>    
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium">
                {{-- Dashboard --}}
                <li class="">
                    <a href="#" class="flex items-center p-2 rounded-lg text-gray-900 {{ $pageActive == "dashboard" ? 'bg-gray-100 dark::bg-gray-700' : 'hover:bg-gray-100 dark:hover:bg-gray-700 group' }}">
    ...
    <div class="p-4 sm:ml-64">
        {{-- Navbar --}}
        <div class="navbar bg-primary sticky top-3 rounded-lg mb-4 px-4">
            {{-- Page --}}
